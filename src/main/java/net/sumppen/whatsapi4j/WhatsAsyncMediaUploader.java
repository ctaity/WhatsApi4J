...
//		String resume = uploadResponseNode.getChild("media").getAttribute("resume");
    ...
    private static JSONObject getPostString(String filepath, String url, File mediaFile, String to, String from, String resume) throws NoSuchAlgorithmException, IOException {
        int startFrom = 0;
